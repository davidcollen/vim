...
#   ------------------------------------------------------------
    ...
    export PATH="$PATH:/usr/local/Cellar/gettext/0.19.3/bin/"
    export PATH="~/bin:/usr/local/git/bin:/sw/bin/:/usr/local/bin:/usr/local/:/usr/local/sbin:/usr/local/mysql/bin:$PATH"
...
alias vi='~/bin/vimintab.applescript'
