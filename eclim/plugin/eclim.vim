...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/Volumes/store/Users/davidcollen/Applications/eclipse/plugins/org.eclim_2.2.5'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/Volumes/store/Users/davidcollen/Applications/eclipse'
  if has('win32unix')
